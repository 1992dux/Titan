...
public class Purify {
	public static void main(String[] args) {
		...
		// place to store tomcat log file
		String fileName = "/Users/xiaodu/Downloads/tomcat_log.txt";
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {				
				// Sample input : 
				// 94.37.123.42 - - [06/Sep/2017:01:57:30 +0000] "HEAD /db/db-admin/ HTTP/1.1" 404 -
